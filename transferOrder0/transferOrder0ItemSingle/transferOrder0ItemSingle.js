  ...
  update: function () {
    ...
    if (that.data.transfer_order_item_list.data[index].realAmount == that.data.transfer_order_item_list.data[index].scheduledAmount) {
      ...
      var object_output_transfer_order_item = {
        ...
        "unit": that.data.transfer_order_item_list.data[index].unit,
        "unitAmount": that.data.transfer_order_item_list.data[index].unitAmount,
        "comment": that.data.transfer_order_item_list.data[index].comment,
        ...
        complete: function () {
          ...
          if (res_temp.statusCode == 200) {
            ...
            if (that.data.scan_model == 2) {
              ...
              globaldata.transfer_barcode = barcode
              console.log("global缓存的内容")
              console.log(globaldata.transfer_barcode)
              that.setData({
                rescode: '',
                focus: true
              });
